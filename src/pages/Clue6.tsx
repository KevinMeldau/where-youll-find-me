   ...
   return (
      <div className="flex flex-col h-dvh">
         ...
         <div className="overflow-y-auto flex-1 mt-4 px-4">
            ...
            <p className="mb-4">
               And what I hope you see now is this: <span className="font-bold">You did this.</span> You chose to trust. You moved when you could’ve hesitated. You kept going, even when you didn’t have all the answers.<br />That’s courage. That’s strength. That’s you. So carry that. Let it stay with you.
            </p>
